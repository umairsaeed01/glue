    ...
    \begin{rSection}{Work Experience}
                ...
                {Cyber Security Intern}{April 2024 - July 2024}
                                ...
                                {\normalfont{\textit{Melbourne, VIC}}}
                                    \item Developed a C{-}based security alert classifier with anomaly detection, reducing false positives by 25\% and enhancing real{-}time data accuracy, aligning with AI engineering practices.
...
%==== TECHNICAL STRENGTHS SECTION ====%
    \begin{rSection}{Technical Skills}
        \begin{tabular}{ @{} l @{\hspace{1ex}} l }
                                ...
                                \textbf{AI and Software Development}: Software Development, Machine Learning\\
                                \textbf{Cloud and Database Technologies}: Database Indexing \& Optimization, Data Modeling\\
                                \textbf{Tools \& Technologies}: Functions, Triggers\\
                                \textbf{Soft Skills}: Analytical Thinking, Problem Solving, Time Management\\
                        \textbf{Certifications:} 
                                            \href{https://www.cppinstitute.org/certified{-}cpp{-}developer}{\textbf{Certified C++ Developer}},\\
                                            \href{https://www.pmi.org/certifications/agile{-}certified{-}practitioner{-}acp}{\textbf{Agile Certified Practitioner (ACP)}},\\
...
% ACHIEVEMENTS SECTION
    \begin{rSection}{Achievements}
        \begin{rSubsection}{}{}{}
                            \item Led the development of a high{-}performance telemetry data processing module, reducing processing time by 40\% through efficient algorithm design
                            \item Received recognition for implementing a low{-}latency networking architecture that improved data transfer speeds by 50\%
                            \item Contributed to the optimization of existing C++ codebase, resulting in a 30\% increase in overall system performance
                    \end{rSubsection}
    \end{rSection}

\newcommand\myfontsize{\fontsize{0.1pt}{0.1pt}\selectfont} \myfontsize \color{white}
C++ development, low{-}latency algorithms, high{-}throughput networking, time{-}series relational databases, Windows desktop applications, multithreading, real{-}time systems, object{-}oriented design, AGSVA security clearance, CMake, Ninja build systems, Linux cross{-}compilation, data science, machine learning, code optimization, UI integration, parallel computing, Agile software development, C++ development, low{-}latency algorithms, high{-}throughput networking, time{-}series relational databases, Windows desktop applications, multithreading, real{-}time systems, object{-}oriented design, AGSVA security clearance, CMake, Ninja build systems, Linux cross{-}compilation, data science, machine learning, code optimization, UI integration, parallel computing, Agile software development, {artificial intelligence engineer, azure cognitive services exp, azure services, core azure services, azure cognitive and generative ai, genai, aws,  gcp, java, clean, efficient, maintainable code, react, front end, back end, ai solutions, data analysis, pretrained models, automl, software development principles, version control, testing, continuous integration and deployment, python, javascript, prompt engieering, frontend, backend, html, css, api, angular, development, machine learning, artificial intelligence, deep learning, data warehouse, data modeling, data extraction, data transformation, data loading, sql, etl, data quality, data governance, data privacy, data visualization, data controls, privacy, security, compliance, sla, aws, terabyte to petabyte scale data, full stack software development, cloud, security engineering, security architecture, ai/ml engineering, technical product management, microsoft office, google suite, visualization tools, scripting, coding, programming languages, analytical skills, collaboration, leadership, communication, presentation skills, computer vision, senior, ms or ph.d., 3d pose estimation, slam, robotics, object tracking, real-time systems, scalability, autonomy, robotic process automation, java, go, matlab, devops, ci/cd, programming, computer vision, data science, machine learning frameworks, deep learning toolsets, problem-solving, individual contributor, statistics, risk assessments, statistical modeling, apis, technical discussions, cross-functional teams}
