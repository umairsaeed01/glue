...
% ACHIEVEMENTS SECTION
    \begin{rSection}{Achievements}
        \begin{rSubsection}{}{}{}
                            ...
                            \item Received the 'Innovator of the Year' award for spearheading the implementation of AI{-}driven predictive maintenance solutions in the mining sector
                            \item Collaborated with a multidisciplinary team to deploy a scalable AI infrastructure using FastAPI and AWS, enhancing data processing speed by 40\%
                    \end{rSubsection}
    \end{rSection}
