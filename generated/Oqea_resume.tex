...
% ACHIEVEMENTS SECTION
    \begin{rSection}{Achievements}
        \begin{rSubsection}{}{}{}
                            \item Led the development of a scalable Vue.js frontend application for a healthcare platform
                            \item Implemented Python{-}based intelligent agents for mental health consultation support
                            \item Designed and executed measurement frameworks to evaluate agent performance and accuracy
                            \item Optimized fine{-}tuning workflows resulting in enhanced agent responses
                            \item Ensured seamless integration between full{-}stack applications and agentic systems
                            \item Mentored junior developers in full{-}stack and AI technologies
                            \item Demonstrated technical leadership in integrating traditional web applications with intelligent agent workflows
                    \end{rSubsection}
    \end{rSection}
