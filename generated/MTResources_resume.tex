...
%==== TECHNICAL STRENGTHS SECTION ====%
    \begin{rSection}{Technical Skills}
        \begin{tabular}{ @{} l @{	} l }
                                \textbf{Programming}: SQL, PL/SQL, Apex code, Triggers, Classes, APIs\\
                                \textbf{Technology}: Oracle Database, AWS, Azure, Data migration, User training, Custom reports, Dashboards\\
