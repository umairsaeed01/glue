    ...
    \begin{rSection}{Work Experience}
                ...
                {Cyber Security Intern}{April 2024 - July 2024}
                                ...
                                {\normalfont{\textit{Melbourne, VIC}}}
                                    ...
                                    \item Executed penetration testing automation using ML{-}based pattern recognition models, significantly improving threat detection efficiency.
                                    \item Created dashboard visualizations to monitor compliance metrics using Power BI \& Python, facilitating streamlined data{-}driven decision{-}making processes.
                            \end{rSubsection}
            \end{rSection}
    ...
    \begin{rSection}{Technical Skills}
        \begin{tabular}{ @{} l @{\hspace{1ex}} l }
                        ...
                        \textbf{Certifications:} 
                                            \href{www.softwareanalysisinstitute.com/certification}{\textbf{Certified Software Systems Analyst}},\\
                                            \href{www.manufacturingsystemsassociation.com/certification}{\textbf{Industrial Systems Optimization Certification}},\\
