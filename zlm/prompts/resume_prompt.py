...
2. Create compelling resumes:
   ...
   - ONLY modify existing experience and project points from the provided resume—NEVER fabricate new roles, companies, or achievements
   - Strictly maintain accuracy of experience duration and roles directly from the provided resume; NEVER assume or invent durations or roles
   - Retain all original company names exactly as provided; NEVER create or modify company names
   - NEVER invent, fabricate, or exaggerate experiences, roles, awards, companies, or metrics not explicitly stated in the provided resume.
- Verify all dates, roles, companies, and achievements strictly from the provided resume.
- If any detail is unclear or missing, do NOT assume or add it.
