...
# os.system("playwright install") # Should be done during setup, not runtime
# os.system("sudo playwright install-deps") # Requires password, will hang; should be done during setup
...
import os
print("DEBUG: OPENAI_API_KEY in web_app.py:", os.getenv("OPENAI_API_KEY"))